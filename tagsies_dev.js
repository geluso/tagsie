/* Bookmarklet code. Paste this within the address bar to run Tagsie within Facebook.
...
function init() {    
    ...
    evt.initMouseEvent('click', true, true, window, 1, 593, 500, 500, 500, false, false, false, false, 0, null);
...
document.getElementById('tagging_instructions_default_message').innerHTML =     
    ...
    "<div id='tagsiestatus'>" +
        ...
        "within the regular Facebook tagger or the Tagsie Process may be ruined. " +
